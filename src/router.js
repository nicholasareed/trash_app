        ...
        var DefaultRouter = Backbone.Router.extend({
            ...
            routes: {
                ...
                'todo/add/summary(/:hash)' : function(){
                    defaultRoute('TodoAddSummary', 'Todo/AddSummary', arguments, {cache: true});
                },
                'todo/add/location(/:hash)' : function(){
                    defaultRoute('TodoAddAddress', 'Todo/AddAddress', arguments, {cache: true});
                },
                'todo/add/payment(/:hash)' : function(){
                    defaultRoute('TodoAddPayment', 'Todo/AddPayment', arguments, {cache: true});
                },
                // 'todo/add/team(/:hash)' : function(){
                //     defaultRoute('TodoAddTeam', 'Todo/AddTeam', arguments, {cache: true});
                // },
                // 'todo/add/player(/:hash)' : function(){
                //     defaultRoute('TodoAddPlayer', 'Todo/AddPlayer', arguments, {cache: true});
                // },
                // 'todo/add/result(/:hash)' : function(){
                //     defaultRoute('TodoAddResult', 'Todo/AddResult', arguments, {cache: true});
                // },
                // 'todo/add/detail(/:hash)' : function(){
                //     defaultRoute('TodoAddDetail', 'Todo/AddDetail', arguments, {cache: true});
                // },
                'todo/add' : function(){
                    defaultRoute('TodoAdd', 'Todo/AddWizard', arguments, {cache: false});
                },
                ...
                'todo/list_as_driver' : function(){
                    App.Views.MainFooter.route_show = true;
                    App.Views.MainFooter.Tabs.select('todos', false);
                    defaultRoute('TodoListDriver', 'Todo/ListAsDriver', arguments);
                },
                'todo/list_as_admin' : function(){
                    App.Views.MainFooter.route_show = true;
                    App.Views.MainFooter.Tabs.select('todos', false);
                    defaultRoute('TodoListAdmin', 'Todo/ListAsAdmin', arguments);
                },
