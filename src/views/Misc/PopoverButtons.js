...
define(function(require, exports, module) {
    ...
    function PageView(params) {
        ...
        this.contentScrollView.SizeMod = new Modifier({
            size: function(){
                // if(that.contentScrollView.SeqLayout){
                //     console.log('-----------');
                //     // console.log(that.form.trueSize());
                //     console.log(that.contentScrollView.SeqLayout.getSize());
                //     // console.log(that.contentScrollView.SeqLayout._size);
                // }
                var defaultSize = 200;
                ...
                // console.log(newSize);
                return [window.innerWidth - 80, newSize] // default 200 sizing
            }
