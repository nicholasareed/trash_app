...
define(function(require, exports, module) {
    ...
    var AllView      = require('./Subviews/AddPaymentAll');
    ...
    function PageView(options) {
        ...
        if(!this.options.App.Cache.TodoAddPaymentOptions){
            console.error('no payment options');
            App.history.back();
            return;
        }
        ...
        this.options.passed = _.extend({
            // ;pass
        }, App.Cache.TodoAddPaymentOptions || {});
