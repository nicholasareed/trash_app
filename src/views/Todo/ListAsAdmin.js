...
define(function(require, exports, module) {
    ...
    var FilterView      = require('./Subviews/AllAsAdmin');
    ...
    PageView.prototype.createTabs = function(){
        ...
        this.filterTabs.Submitted.on('click', function(){
            that.tabs.todos = 'submitted';
            that.tab_change();
        ...
        this.filterTabs.Views.push(this.filterTabs.Submitted);
        ...
        this.filterTabs.PendingDriver.on('click', function(){
            that.tabs.todos = 'pending_driver';
            that.tab_change();
            that.filterTabs.Views.forEach(function(tmpView){
                if(tmpView.group == 'Todos'){
                    tmpView.setClasses(['todo-filter-tabs-item-default']);
        ...
        // Select Defaults
        this.filterTabs.Submitted._eventOutput.trigger('click');
