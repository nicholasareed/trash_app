...
define(function(require, exports, module) {
    ...
    // var AllView      = require('./Subviews/AllAsDriver');
    var FilterView      = require('./Subviews/AllAsDriver');
    ...
    PageView.prototype.tab_change = function(name){
        ...
        switch(this.tabs.todos){
            case 'incomplete':
                ...
                empty_string = 'No pickups scheduled';
                filter = {
            ...
            case 'candidates':
                empty_string = 'No pickups available to claim<br />Check back later!';
                filter = {
    ...
    PageView.prototype.createTabs = function(){
        ...
        this.filterTabs.IncompleteTodos.group = 'Todos';
        this.filterTabs.IncompleteTodos.on('click', function(){
            that.tabs.todos = 'incomplete';
            that.tab_change();
        ...
        this.filterTabs.Views.push(this.filterTabs.IncompleteTodos);
        ...
        // Candidates
        this.filterTabs.CandidateTodos = new Surface({
            content: 'Candidates',
            size: [undefined, undefined],
            classes: ['todo-filter-tabs-item-default']
        });
        this.filterTabs.CandidateTodos.group = 'Todos';
        this.filterTabs.CandidateTodos.on('click', function(){
            that.tabs.todos = 'candidates';
            that.tab_change();
            that.filterTabs.Views.forEach(function(tmpView){
                if(tmpView.group == 'Todos'){
                    tmpView.setClasses(['todo-filter-tabs-item-default']);
        ...
        this.filterTabs.Views.push(this.filterTabs.CandidateTodos);
        ...
        // Select Defaults
        this.filterTabs.IncompleteTodos._eventOutput.trigger('click');
